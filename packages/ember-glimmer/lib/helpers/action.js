...
export class ClosureActionReference extends CachedReference {
  ...
  compute() {
    ...
    if (actionType === 'string') {
      ...
      // TODO: Improve the message to pull out the name of the rawAction param.
    ...
    // ELSE some other kind of mut helper?
...
export default {
  ...
  toReference(args) {
    ...
    if (rawActionRef === UNDEFINED_REFERENCE || rawActionRef === NULL_REFERENCE) {
      // TODO: How to determine the label and current scope?
